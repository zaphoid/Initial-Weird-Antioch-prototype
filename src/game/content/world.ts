...
export const zoneProps: ZoneProp[] = [
  ...
  { id: "lib-terminal", zone: "library", kind: "terminal", x: 250, y: 220, label: "Ops Console" },
  { id: "lib-terminal-2", zone: "library", kind: "terminal", x: 250, y: 320, label: "Quest Intake" },
  { id: "lib-rack-1", zone: "library", kind: "rack", x: 800, y: 420, label: "UPS Rack A" },
  { id: "lib-rack-2", zone: "library", kind: "rack", x: 860, y: 420, label: "UPS Rack B" },
  { id: "lib-desk", zone: "library", kind: "desk", x: 650, y: 250, label: "Archivist Desk" },
  { id: "lib-desk-2", zone: "library", kind: "desk", x: 560, y: 250, label: "Reference Desk" },
...
export const zoneLandmarks: ZoneLandmark[] = [
  ...
  },
  {
    ...
    body: "Home base. The board, terminals, and archive whispers make this the mechanical heart of the first slice.",
    x: 210,
    y: 120,
  },
  {
